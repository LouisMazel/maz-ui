<template>
  <div
    class="maz-smart-search"
    :class="[{ 'maz-is-dark': dark }, `maz-smart-search--${color}`]"
    ...
    <transition name="maz-slide">
      ...
      >
        <button
          ...
          class="maz-smart-search__items__item"
...
/**
 * > UI search input component. Extends MazInput, so all props/options of [MazInput](/#/documentation/input) are available here.
 */
export default {
  name: 'MazSmartSearch',
  components: {
