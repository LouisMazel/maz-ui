  ...
  export default {
    ...
    methods: {
      ...
      noticeDeprecation () {
        ...
        if (useDeprecatedAPI) {
          console.warn('[vue-ctk-date-time-picker]: You\'re using a deprecated API. Check the changelog (https://github.com/chronotruck/vue-ctk-date-time-picker/releases) for migration guide.')
        }
      },
      /**
