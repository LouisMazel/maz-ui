      ...
      <div tw="flex flex-col w-full h-full items-center justify-center bg-gray-900">
        <div tw="bg-gray-900 flex w-full">
          <div tw="flex flex-col w-full py-12 px-4 justify-between p-8">
            <svg style={{ margin: 0 }} xmlns="http://www.w3.org/2000/svg" version="1.0" width="7em" viewBox="0 0 1800.000000 710.000000" preserveAspectRatio="xMidYMid meet">
              <g transform="translate(0.000000,710.000000) scale(0.100000,-0.100000)" stroke="none" style={{ fill: 'dodgerblue' }}>
            ...
            <h2 tw="flex flex-col text-4xl font-bold tracking-tight text-gray-200 text-left">
              <span>{title}</span>
            </h2>
            <p tw="text-lg mt-0 text-gray-300">
              {description}
            </p>
            <div tw="mt-2 flex">
              <div tw="flex rounded-xl shadow">
                <a tw="flex items-center justify-center rounded-lg border border-transparent bg-blue-500 px-5 py-3 text-base font-semibold text-white">Get started</a>
              </div>
              <div tw="ml-3 flex rounded-xl shadow">
                <a tw="flex items-center justify-center rounded-lg border border-transparent bg-white px-5 py-3 text-base font-semibold text-blue-500">Learn more</a>
              </div>
            </div>
          </div>
        </div>
