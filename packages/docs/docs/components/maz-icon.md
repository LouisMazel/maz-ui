...
<div class="flex items-start flex-wrap gap-05">
  <div v-for="icon in icons" :key="icon" class="flex flex-col flex-center maz-p-2 maz-rounded" style="border: 1px solid var(--maz-color-bg-light); background-color: var(--maz-color-bg-lighter);">
