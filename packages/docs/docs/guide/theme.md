...
:root {
  ...
  /* SUCCESS */
  --maz-color-success-50: hsl(81deg 63% 94%);
  ...
  /* WARNING */
  --maz-color-warning-50: hsl(39deg 100% 95%);
  --maz-color-warning-100: hsl(39deg 97% 88%);
  ...
  --maz-color-warning-900: hsl(39deg 67% 18%);
  ...
  /* DANGER */
  --maz-color-danger-50: hsl(3deg 100% 96%);
  ...
  --maz-color-danger-800: hsl(2deg 42% 34%);
