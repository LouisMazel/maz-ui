...
<template>
  ...
  >
    <template #default="{ close }">
      <div
        class="m-bottom-sheet__container maz:relative maz:w-full maz:rounded-t-lg maz:bg-container maz:px-12 maz:text-foreground maz:shadow-elevation maz:drop-shadow-md"
        :class="{
          '--padding': padding,
          'maz:py-6': padding,
        }"
