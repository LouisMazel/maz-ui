...
import { MazNoImage } from '@maz-ui/icons/lazy/MazNoImage'
...
export interface MazGalleryProps {
  ...
  scale?: boolean
  /**
   * Choose color of borders between images - Should be a CSS color or CSS variable - Ex: `#000`
   * @type string
   * @default 'transparent'
   */
  separatorColor?: string
  /**
   * Choose background color of the gallery - Should be a CSS color or CSS variable - Ex: `#000`
   * @type string
   * @default undefined
   */
