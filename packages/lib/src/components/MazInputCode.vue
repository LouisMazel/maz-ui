...
<template>
  ...
  >
    <div class="m-input-code__wrapper maz:inline-flex maz:gap-[1em]">
      <div v-for="item in codeLength" :key="item" class="input-wrapper maz:relative maz:size-[4em] maz:overflow-hidden maz:rounded-md maz:border maz:border-solid maz:border-divider maz:transition-colors maz:duration-200 maz:ease-in-out maz:dark:border-divider-400 maz:dark:bg-surface-400" :class="borderColorState">
