...
const COMPONENTS_OUTPUT_PATH_MJS = resolve(__dirname, './../dist/components/index.mjs')
const COMPONENTS_OUTPUT_PATH_UMD = resolve(__dirname, './../dist/components/index.umd.js')
...
const buildEntry = (template: string, importTemplate: string, outputPath: string, ext: string) => {
...
const launch = async () => {
  try {
    buildEntry(COMPONENTS_TEMPLATE, COMPONENTS_IMPORT_TEMPLATE, COMPONENTS_OUTPUT_PATH_MJS, '.mjs')
    buildEntry(
      COMPONENTS_TEMPLATE,
