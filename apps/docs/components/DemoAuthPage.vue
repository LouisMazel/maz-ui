...
<template>
  <div class="vp-raw maz:flex">
    <div class="maz:hidden maz:flex-1 maz:flex-col maz:flex-center maz:gap-2 maz:bg-contrast maz:p-6 maz:tab-m:flex">
