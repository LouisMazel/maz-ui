<template>
  <div class="maz-transition-expand-doc">
    <ComponentContainer class="flex direction-column" :code="code">
      ...
      <div class="flex flex-1 align-start">
        <ComponentContainer class="maz-expand-container flex-1 mr-4">
          <h3 class="mb-2">
            Expand component 1
          </h3>
          <MazTransitionExpand
            class="example shadow-container border-radius text-center"
          >
            <div v-show="!isShown">
              <p>Content expand</p>
              <p>Content expand</p>
